...
;; @@
(defn encode-row-2 [vr-row]
  (let [key-choice (nth vr-row key-idx)]
    (map (fn [x] (if (= key-choice x) 0.9
                   (if (not (= x "abs")) 0.01
                   	(if (or (= key-choice "pro") (= key-choice "con"))  0.5 0.01)))) vr-row)))

(defn test-2 [idx]
  (let [enc  (map encode-row-2 (filter
                    (fn [row] (not (= (nth row key-idx) "abs")))
                    (map rest (rest vote_result))))
        lazy (doquery :ipmcmc single [(map (fn [x] (nth x idx)) enc)])
        samp (map :result (take-nth 10 (take 10000 (drop 5000 lazy))))]
   (print (nth members key-idx) " " (nth members idx) ": " (count enc) "\n")
   (plot/histogram samp :normalize :probability :bins 60)))
;; @@
;; =>
;;; {"type":"list-like","open":"","close":"","separator":"</pre><pre>","items":[{"type":"html","content":"<span class='clj-var'>#&#x27;pro1/encode-row-2</span>","value":"#'pro1/encode-row-2"},{"type":"html","content":"<span class='clj-var'>#&#x27;pro1/test-2</span>","value":"#'pro1/test-2"}],"value":"[#'pro1/encode-row-2,#'pro1/test-2]"}
;; <=

;; @@
(def key-idx (index-of "염동열" members))
(test-2 (index-of "김종인" members))
;; @@
;; ->
;;; 염동열   김종인 :  1449 
;;; 
;; <-
;; =>
;;; {"type":"list-like","open":"","close":"","separator":"</pre><pre>","items":[{"type":"html","content":"<span class='clj-var'>#&#x27;pro1/key-idx</span>","value":"#'pro1/key-idx"},{"type":"vega","content":{"width":400,"height":247.2187957763672,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"54a624e1-7f71-4dc9-9ce3-662a93a676b3","values":[{"x":0.02263840992385142,"y":0},{"x":0.038738817358331304,"y":0.002},{"x":0.05483922479281119,"y":0},{"x":0.07093963222729108,"y":0.004},{"x":0.08704003966177096,"y":0.003},{"x":0.10314044709625084,"y":0.007},{"x":0.11924085453073072,"y":0.005},{"x":0.1353412619652106,"y":0.006},{"x":0.15144166939969048,"y":0.011},{"x":0.16754207683417036,"y":0.01},{"x":0.18364248426865024,"y":0.007},{"x":0.19974289170313012,"y":0.018},{"x":0.21584329913761,"y":0.012},{"x":0.23194370657208987,"y":0.007},{"x":0.24804411400656975,"y":0.019},{"x":0.26414452144104966,"y":0.015},{"x":0.28024492887552954,"y":0.022},{"x":0.2963453363100094,"y":0.019},{"x":0.3124457437444893,"y":0.016},{"x":0.3285461511789692,"y":0.019},{"x":0.34464655861344906,"y":0.015},{"x":0.36074696604792894,"y":0.022},{"x":0.3768473734824088,"y":0.027},{"x":0.3929477809168887,"y":0.022},{"x":0.4090481883513686,"y":0.024},{"x":0.42514859578584846,"y":0.015},{"x":0.44124900322032834,"y":0.017},{"x":0.4573494106548082,"y":0.032},{"x":0.4734498180892881,"y":0.021},{"x":0.489550225523768,"y":0.031},{"x":0.5056506329582479,"y":0.031},{"x":0.5217510403927278,"y":0.025},{"x":0.5378514478272077,"y":0.025},{"x":0.5539518552616877,"y":0.027},{"x":0.5700522626961676,"y":0.03},{"x":0.5861526701306475,"y":0.026},{"x":0.6022530775651275,"y":0.032},{"x":0.6183534849996074,"y":0.041},{"x":0.6344538924340873,"y":0.031},{"x":0.6505542998685673,"y":0.027},{"x":0.6666547073030472,"y":0.025},{"x":0.6827551147375271,"y":0.029},{"x":0.6988555221720071,"y":0.013},{"x":0.714955929606487,"y":0.022},{"x":0.731056337040967,"y":0.023},{"x":0.7471567444754469,"y":0.028},{"x":0.7632571519099268,"y":0.015},{"x":0.7793575593444068,"y":0.016},{"x":0.7954579667788867,"y":0.014},{"x":0.8115583742133666,"y":0.019},{"x":0.8276587816478466,"y":0.016},{"x":0.8437591890823265,"y":0.012},{"x":0.8598595965168064,"y":0.008},{"x":0.8759600039512864,"y":0.005},{"x":0.8920604113857663,"y":0.011},{"x":0.9081608188202462,"y":0.007},{"x":0.9242612262547262,"y":0.004},{"x":0.9403616336892061,"y":0.003},{"x":0.956462041123686,"y":0.004},{"x":0.972562448558166,"y":0.002},{"x":0.9886628559926459,"y":0.001},{"x":1.0047632634271257,"y":0}]}],"marks":[{"type":"line","from":{"data":"54a624e1-7f71-4dc9-9ce3-662a93a676b3"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"interpolate":{"value":"step-before"},"fill":{"value":"steelblue"},"fillOpacity":{"value":0.4},"stroke":{"value":"steelblue"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"54a624e1-7f71-4dc9-9ce3-662a93a676b3","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"54a624e1-7f71-4dc9-9ce3-662a93a676b3","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\", :values ({:x 0.02263840992385142, :y 0} {:x 0.038738817358331304, :y 0.002} {:x 0.05483922479281119, :y 0.0} {:x 0.07093963222729108, :y 0.004} {:x 0.08704003966177096, :y 0.003} {:x 0.10314044709625084, :y 0.007} {:x 0.11924085453073072, :y 0.005} {:x 0.1353412619652106, :y 0.006} {:x 0.15144166939969048, :y 0.011} {:x 0.16754207683417036, :y 0.01} {:x 0.18364248426865024, :y 0.007} {:x 0.19974289170313012, :y 0.018} {:x 0.21584329913761, :y 0.012} {:x 0.23194370657208987, :y 0.007} {:x 0.24804411400656975, :y 0.019} {:x 0.26414452144104966, :y 0.015} {:x 0.28024492887552954, :y 0.022} {:x 0.2963453363100094, :y 0.019} {:x 0.3124457437444893, :y 0.016} {:x 0.3285461511789692, :y 0.019} {:x 0.34464655861344906, :y 0.015} {:x 0.36074696604792894, :y 0.022} {:x 0.3768473734824088, :y 0.027} {:x 0.3929477809168887, :y 0.022} {:x 0.4090481883513686, :y 0.024} {:x 0.42514859578584846, :y 0.015} {:x 0.44124900322032834, :y 0.017} {:x 0.4573494106548082, :y 0.032} {:x 0.4734498180892881, :y 0.021} {:x 0.489550225523768, :y 0.031} {:x 0.5056506329582479, :y 0.031} {:x 0.5217510403927278, :y 0.025} {:x 0.5378514478272077, :y 0.025} {:x 0.5539518552616877, :y 0.027} {:x 0.5700522626961676, :y 0.03} {:x 0.5861526701306475, :y 0.026} {:x 0.6022530775651275, :y 0.032} {:x 0.6183534849996074, :y 0.041} {:x 0.6344538924340873, :y 0.031} {:x 0.6505542998685673, :y 0.027} {:x 0.6666547073030472, :y 0.025} {:x 0.6827551147375271, :y 0.029} {:x 0.6988555221720071, :y 0.013} {:x 0.714955929606487, :y 0.022} {:x 0.731056337040967, :y 0.023} {:x 0.7471567444754469, :y 0.028} {:x 0.7632571519099268, :y 0.015} {:x 0.7793575593444068, :y 0.016} {:x 0.7954579667788867, :y 0.014} {:x 0.8115583742133666, :y 0.019} {:x 0.8276587816478466, :y 0.016} {:x 0.8437591890823265, :y 0.012} {:x 0.8598595965168064, :y 0.008} {:x 0.8759600039512864, :y 0.005} {:x 0.8920604113857663, :y 0.011} {:x 0.9081608188202462, :y 0.007} {:x 0.9242612262547262, :y 0.004} {:x 0.9403616336892061, :y 0.003} {:x 0.956462041123686, :y 0.004} {:x 0.972562448558166, :y 0.002} {:x 0.9886628559926459, :y 0.001} {:x 1.0047632634271257, :y 0})}], :marks [{:type \"line\", :from {:data \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :interpolate {:value \"step-before\"}, :fill {:value \"steelblue\"}, :fillOpacity {:value 0.4}, :stroke {:value \"steelblue\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"}],"value":"[#'pro1/key-idx,#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\", :values ({:x 0.02263840992385142, :y 0} {:x 0.038738817358331304, :y 0.002} {:x 0.05483922479281119, :y 0.0} {:x 0.07093963222729108, :y 0.004} {:x 0.08704003966177096, :y 0.003} {:x 0.10314044709625084, :y 0.007} {:x 0.11924085453073072, :y 0.005} {:x 0.1353412619652106, :y 0.006} {:x 0.15144166939969048, :y 0.011} {:x 0.16754207683417036, :y 0.01} {:x 0.18364248426865024, :y 0.007} {:x 0.19974289170313012, :y 0.018} {:x 0.21584329913761, :y 0.012} {:x 0.23194370657208987, :y 0.007} {:x 0.24804411400656975, :y 0.019} {:x 0.26414452144104966, :y 0.015} {:x 0.28024492887552954, :y 0.022} {:x 0.2963453363100094, :y 0.019} {:x 0.3124457437444893, :y 0.016} {:x 0.3285461511789692, :y 0.019} {:x 0.34464655861344906, :y 0.015} {:x 0.36074696604792894, :y 0.022} {:x 0.3768473734824088, :y 0.027} {:x 0.3929477809168887, :y 0.022} {:x 0.4090481883513686, :y 0.024} {:x 0.42514859578584846, :y 0.015} {:x 0.44124900322032834, :y 0.017} {:x 0.4573494106548082, :y 0.032} {:x 0.4734498180892881, :y 0.021} {:x 0.489550225523768, :y 0.031} {:x 0.5056506329582479, :y 0.031} {:x 0.5217510403927278, :y 0.025} {:x 0.5378514478272077, :y 0.025} {:x 0.5539518552616877, :y 0.027} {:x 0.5700522626961676, :y 0.03} {:x 0.5861526701306475, :y 0.026} {:x 0.6022530775651275, :y 0.032} {:x 0.6183534849996074, :y 0.041} {:x 0.6344538924340873, :y 0.031} {:x 0.6505542998685673, :y 0.027} {:x 0.6666547073030472, :y 0.025} {:x 0.6827551147375271, :y 0.029} {:x 0.6988555221720071, :y 0.013} {:x 0.714955929606487, :y 0.022} {:x 0.731056337040967, :y 0.023} {:x 0.7471567444754469, :y 0.028} {:x 0.7632571519099268, :y 0.015} {:x 0.7793575593444068, :y 0.016} {:x 0.7954579667788867, :y 0.014} {:x 0.8115583742133666, :y 0.019} {:x 0.8276587816478466, :y 0.016} {:x 0.8437591890823265, :y 0.012} {:x 0.8598595965168064, :y 0.008} {:x 0.8759600039512864, :y 0.005} {:x 0.8920604113857663, :y 0.011} {:x 0.9081608188202462, :y 0.007} {:x 0.9242612262547262, :y 0.004} {:x 0.9403616336892061, :y 0.003} {:x 0.956462041123686, :y 0.004} {:x 0.972562448558166, :y 0.002} {:x 0.9886628559926459, :y 0.001} {:x 1.0047632634271257, :y 0})}], :marks [{:type \"line\", :from {:data \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :interpolate {:value \"step-before\"}, :fill {:value \"steelblue\"}, :fillOpacity {:value 0.4}, :stroke {:value \"steelblue\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"54a624e1-7f71-4dc9-9ce3-662a93a676b3\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}]"}
;; <=
